...
/** Classe controle responsavel pelos penaltis da disputa pelo terceiro lugar
 * 
 * @author Weslei Silva Santos
 *
 */
public class Penaltis3LugarController {
	private Partida partida = CRUD3LugarController.getEmpates().get(0);
    ...
    void registrarAction(ActionEvent event) {
    	try {
	    	...
	    	if(penalti1!=penalti2) {
		    	...
		    	tercLugarDao.UpdatePart(partida, partida.getId());
		    	CRUD3LugarController.getEmpates().remove(0);
		    	try {
